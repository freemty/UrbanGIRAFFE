...
import yaml
import sys
from tools.kitti360Scripts.devkits.commons.loadCalibration import loadCalibrationCameraToPose
...
if __name__=="__main__":
    ...
    kitti360Path = '/data/ybyang/KITTI-360'
    seq = 0
    cam_id = 0
    ...
    start_idx = int(np.argwhere(camera.frames == frame_start))
    frames = camera.frames[start_idx : start_idx + frame_num].astype(int)
    # 3D bbox
